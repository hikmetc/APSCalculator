...
with st.sidebar:
    ...
    if number_CDL == 1:
        ...
        cdl_1 = st.number_input(label='**Enter Clinical Decision Limit(s) Below (from lowest to largest):** Please check final category intervals on "Distribution of data" page',min_value=0.00000 ,format="%.f",key=2)
...
if analyze_button:
    try:
        ...
        st.write(error)
        st.error('The number of measurand results belonging to a particular category may be too low for determination of APS for MU. You may check your clinical decision limits or upload larger data set.')   
