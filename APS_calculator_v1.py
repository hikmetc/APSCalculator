...
with tab1:
    st.markdown("""
                ...
                2. Select the measurand name. (e.g. from template.xlsx file "Fasting Glucose (mg/dL)")
                3. Enter relative standard measurement uncertainty (urel) of the selected data. (e.g. 1.5% u_rel(known))
                ...
                5. Enter the number of clinical decision limits you want to include in the APS determination processs (e.g. e.g. for glucose example in the template.xlsx file, there are two CDLs (100 mg/dL and 125 mg/dL))
                6. Enter the value(s) of clinical decision limit(s) (e.g. e.g. for glucose example in the template.xlsx file, CDLs are 100 mg/dL and 125 mg/dL, 
                Note: Please check final category intervals on "Distribution of data" page. For glucose example 2nd CDL 125 included in 100-125 interval, while 126 is within the interval of >125 (≥126))
