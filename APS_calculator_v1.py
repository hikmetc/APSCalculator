...
with tab1:
    ...
    st.markdown("""        
                ...
                **Step 3**: Recategorization of measured (simulated) concentration based on the clinical decision limits set in Step 1.
                ...
                The overall agreement between the ResultO and ResultM categories and the sublevel agreement based on the clinical decision limits are calculated for each urel rate along with sensitivity and specificity values.
