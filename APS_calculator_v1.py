...
if analyze_button:
    try:
        ...
        st.write(error)
        st.error('The number of measurand results belonging to a particular category are too low for determination of APS for MU. You may check your clinical decision limits or upload larger data set.')   
