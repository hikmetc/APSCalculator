    ...
    try:
        with st.spinner('**Please wait... Status:**'):
            ...
            with tab2:
                ...
                categories_h = sorted([cat for cat in categories_h if cat.startswith("<")]) + sorted([cat for cat in categories_h if not cat.startswith("<") and not cat.startswith("≥")]) + sorted([cat for cat in categories_h if cat.startswith("≥")])
